CREATE OR REPLACE PACKAGE PK_INF_VENTAS_BICICLETAS
IS 
    NOMBRE VARCHAR2(500);
...
CREATE OR REPLACE PACKAGE BODY PK_INF_VENTAS_BICICLETAS
IS
    FUNCTION FN_NOMBRE_TIENDA(ID_TIENDA STORES.STORE_ID%TYPE) RETURN VARCHAR2
        IS
...
DECLARE 
    NOMBRE VARCHAR2(500);
BEGIN
    NOMBRE := PK_INF_VENTAS_BICICLETAS.FN_NOMBRE_TIENDA(2);
    DBMS_OUTPUT.PUT_LINE('NOMBRE DE LA TIENDA ES;' || NOMBRE);
    
    PK_INF_VENTAS_BICICLETAS.SP_INSERTA_BRAND('DIUNSA');
END;
